...
[Open an issue](https://github.com/bitscon/pixel-billy/issues) with:
...
Have an idea? [Open an issue](https://github.com/bitscon/pixel-billy/issues) to discuss it before building. This helps avoid duplicate work and ensures the feature fits the project's direction.
